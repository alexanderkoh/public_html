/*! gradient animation*/
{
    ...
    DOM.links.forEach((link, pos) => {
        ...
        link.addEventListener('click', (ev) => {
			console.log('click');
			document.getElementById('logo-container').classList.add('back-logo')
			document.getElementById('main').classList.remove('active-main')
			document.getElementById('logo').src="img/logo-white.png"
			document.getElementById('mobile-logo').src="img/logo-white.png"
			document.getElementById('coin').src="img/coin-white.png"
            ev.preventDefault();
            open(pos);
        });
    });
...
//        blobs.filter(el => el != currentBlob).forEach(blob => blob.hide());
    ...
    const close = () => {
		document.getElementById('main').classList.add('active-main')
		document.getElementById('logo').src="img/logo.png"
		document.getElementById('coin').src="img/coin.png"
